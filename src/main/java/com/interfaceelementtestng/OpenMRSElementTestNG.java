...
public interface OpenMRSElementTestNG {
	...
	//Scenario 1 --> Login
		...
		String patient_detial_xpath = "//li[normalize-space()='Manic R Basha']";
		
		//End Visit
		
		String endvisit_xpath = "//ul[@class='float-left d-none d-lg-block']//li[1]";
		
		String confirmendvisit_xpath = "(//button[text()='Yes'])[2]";
		//String confirmendvisit_xpath = "div[contains(text(),'                                    End Visit')]";
